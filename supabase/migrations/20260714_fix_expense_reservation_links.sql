...
-- Recover expense submissions that were saved before the missing link table caused an error.
insert into public.expense_reservations (expense_id, reservation_id)
select id, reservation_id
from public.expenses
where reservation_id is not null
on conflict (expense_id, reservation_id) do nothing;
